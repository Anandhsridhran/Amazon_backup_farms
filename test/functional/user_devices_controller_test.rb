...
class UserDevicesControllerTest < ActionController::TestCase
  ...
  test "should create user_device" do
    assert_difference('UserDevice.count') do
      post :create, user_device: { is_active: @user_device.is_active, regid: @user_device.regid, user_id: @user_device.user_id }
    end
  ...
  test "should update user_device" do
    put :update, id: @user_device, user_device: { is_active: @user_device.is_active, regid: @user_device.regid, user_id: @user_device.user_id }
    assert_redirected_to user_device_path(assigns(:user_device))
  end
